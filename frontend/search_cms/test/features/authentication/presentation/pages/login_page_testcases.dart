// Widget test cases for the login page
// Verifies:
//  - Fields render
//  - Empty form handling
//  - Invalid email
//  - Invalid password
// Called by login_page_test.dart and sys_login_test.dart
// Requires that buildWrappedLoginPage is the login page wrapped
// and ready to be pumped (inside MaterialApp, Sizer...)
...
void runLoginPageTestCases(Widget Function() buildWrappedLoginPage) {
  ...
  group('LoginPage', () {
    ...
    testWidgets('LOGIN-PAGE-1-renders email/password fields and submit button', (tester) async {
      await tester.pumpWidget(buildWrappedLoginPage());
